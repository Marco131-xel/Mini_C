...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(lista) { return lista.map(e => e[0]) };
  var peg$f2 = function(id, valor) { return { tipo: "llave", id, valor } };
  var peg$f3 = function(id, p) { return { tipo: "lista", id, parametros: p ?? [] } };
  var peg$f4 = function(first, rest) { return [first, ...rest.map(r => r[1])] };
  var peg$f5 = function(id, valor) { return { id, valor } };
  var peg$f6 = function(chars) { return chars.join(""); };
  var peg$f7 = function() { return text(); };
  var peg$f8 = function() { return "EOF"; };
